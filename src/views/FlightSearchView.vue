        ...
        <div class="container-fluid">
            <div class="row">
                <div class="banner-area v-2">
                    <img
                        src="../src/moban7664/static/picture/vacation.png"
                        alt=""
                        class="left-image"
                    />
                    <div class="content-box text-alignment">
                        <h1 class="fw-700 lightest-black">搜尋航班</h1>
                    </div>
                    <img
                        src="../src/moban7664/static/picture/plane-2.png"
                        alt=""
                        class="right-image"
                    />
                </div>
                ...
                <div class="content">
                    <div class="card">
                        ...
                        <div class="card-body tab-content">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div class="custom-sel-input-block">
                                                ...
                                                >
                                                    <span class="total-pasenger"
                                                        >2</span
                                                    >
                                                    Passengers /
                                                    <span class="pasenger-class"
                                                        >Business</span
                                                    >
                                                </div>
                            ...
                            <!-- StopOver tab Start -->
                            <div class="tab-pane" id="stopover">
                                <form
                                    action="flight-listing.html"
                                    method="post"
                                >
                                    ...
                                    <div class="booking-info mb-32">
                                        ...
                                        >
                                            ...
                                            <div class="custom-sel-input-block">
                                                ...
                                                <div
                                                    class="passenger-area bg-white light-shadow br-5 p-24"
                                                >
                                                    <h4
                                                        class="color-black mb-32"
                                                    >
                                    ...
                                    <div class="row">
                                        <div
                                            class="col-xl-5 col-lg-5 col-md-5 col-sm-5 mb-md-0 mb-24"
                                        >
                                            <h5 class="color-medium-gray mb-24">
                                                When would you like to add a
                                                stop in dubai during your
                                                journey?
                                            </h5>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        ...
                        >
                            <div class="flight-area">
                                <div class="airline-name">
                                    <img
                                        src="../src/moban7664/static/picture/icon-1.png"
                                        alt=""
                                    />
                                    <div>
                                ...
                                <div class="flight-button">
                                    <div class="amount">
                                        ...
                                        <h6 class="dark-gray text-end">
                                            Price
                                        </h6>
                                    </div>
                                    <a
                                        href="flight-booking.html"
                                        class="cus-btn btn-sec"
                                        >Book Now</a
                                    >
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div>
                                    <a
                                        href="#"
                                        class="accordion-button color-primary h5 collapsed"
                        ...
                        <div
                            id="flightDetail"
                            class="accordion-collapse collapse mb-32"
                            ...
                            >
                                <div class="col-lg-3 col-sm-4">
                                    <div class="time-detail">
                                        <h6 class="flight-date mb-32">
                                            14 August, 2023
                                        </h6>
                                        <h6 class="color-black mb-8">
                                            Monday, Aug 14 - 12:00
                                        </h6>
                                ...
                                <div class="col-lg-9 col-sm-8">
                                    <div class="detail-block">
                                        <div
                                            class="d-sm-flex d-block align-items-center gap-24"
                                        >
                                            <img
                                                src="../src/moban7664/static/picture/icon-1.png"
                                                alt=""
                                            ...
                                            <div class="content">
                                                ...
                                                <h6 class="dark-gray">
                                                    Operated by Feel Dubai
                                                    Airlines
                                                </h6>
                                                <h6 class="dark-gray">
                                                    Economy | Flight FK234 |
                        ...
                        >
                            <div class="flight-area">
                                <div class="airline-name">
                                    <img
                                        src="../src/moban7664/static/picture/icon-2.png"
                                        alt=""
                                    />
                                    <div>
                                        <h5 class="lightest-black mb-8">
                        ...
                        >
                            ...
                            >
                                ...
                                <div>
                                    <a
                                        href="#"
                                        class="accordion-button color-primary collapsed h5"
                                        data-bs-toggle="collapse"
