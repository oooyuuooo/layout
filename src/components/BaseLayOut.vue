<template>
    <div class="o-scroll" id="js-scroll">
        <a href="#main-wrapper" id="backto-top" class="back-to-top" style="border-radius: 40px;"><i class="fa-solid fa-caret-up"></i></a>
            ...
            <div class="container-fluid">
                <div class="main-menu__block">
                    <div class="main-menu__left">
                        ...
                        <div class="main-menu__nav">
                            <ul class="main-menu__list">
                                <li>
                                    <a href="/Index" class="active">SparkleAir</a>
                                </li>
                                <li class="dropdown">
                    ...
                    <div class="main-menu__right">
                        ...
                        >
                            <RouterLink class="main-menu__login" to="/login">登入</RouterLink>
                            <div class="center_slach d-xl-flex d-none">
                                /
                            </div>
                            <RouterLink class="main-menu__login" to="/sign-up">註冊</RouterLink>
                        </div>
                        <a
                            href="#"
    ...
    <footer class="footer bg-white p-40"
            data-sal="slide-down"
...
const refreshData = () => {
  // Your logic for refreshing data
